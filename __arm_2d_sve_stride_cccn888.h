...
#if !defined(__ARM_2D_SVE_STRIDE_CCCN888_H__) && (defined(__ARM_FEATURE_SVE2) && __ARM_FEATURE_SVE2)
    ...
    uint16_t hwOpacity)
{
    __arm_2d_sve_stride_loop_ccca8888__(uStride, vTailPred)
    {
        ...
        /* process low half */
        __arm_2d_sve_pixel_ccca_foreach_chn012__(vColour16x4,
                                                 vTargetLow16x4,

                                                 __svu16_target__ = __arm_2d_sve_chn_blend_with_opacity(__svu16_source__,
                                                                                                        __svu16_target__,
                                                                                                        hwOpacity);
                                        ...
                                        size_t uStride)
{
    ...
    __arm_2d_sve_stride_loop_ccca8888__(uStride, vTailPred)
    {
        ...
        /* process high half */
        __arm_2d_sve_pixel_ccca_foreach_chn__(vSourceLow16x4,
                                              vTargetHigh16x4,
                                              __svu16_target__ = svrev(__svu16_source__););
    ...
    uint16_t hwOpacity)
{
    ...
    __arm_2d_sve_stride_loop_ccca8888__(uStride, vTailPred)
    {
        ...
        __arm_2d_sve_pixel_ccca_foreach_chn012__(vSourceHigh16x4,
                                                 ...
                                                 __svu16_target__ = __arm_2d_sve_chn_blend_with_opacity(svrev(__svu16_source__),
                                                                                                        __svu16_target__,
                                                                                                        hwOpacity);
